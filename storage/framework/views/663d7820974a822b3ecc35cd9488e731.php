...
<head>
    ...
    <link rel="icon" href="<?php echo e($logoPath); ?>">
...
<body>
        ...
        <div class="max-w-full mx-auto px-8 sm:px-10 lg:px-12">
            <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="<?php echo e(url('/')); ?>" class="nav-link text-white hover:text-blue-400 font-semibold text-lg transition">Beranda</a>
                    ...
                    <a href="<?php echo e(route('publikasi.index')); ?>" class="nav-link text-white hover:text-blue-400 font-semibold text-lg transition">Publikasi</a>
    ...
    <section class="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div id="hero-slider" class="absolute inset-0 w-full h-full">
            <?php $__currentLoopData = $heroBackgrounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="text-center text-white px-4 hero-content">
            ...
            <h1 class="text-6xl md:text-7xl font-bold mb-4 drop-shadow-lg"><?php echo e($heroTitle); ?></h1>
            <p class="text-xl md:text-2xl font-medium drop-shadow-lg"><?php echo e($heroTagline); ?></p>
        </div>
        ...
        <div class="slider-thumbnails">
            <?php $__currentLoopData = $heroBackgrounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="slider-thumbnail <?php echo e($index === 0 ? 'active' : ''); ?>" 
                     style="background-image: url('<?php echo e($bg); ?>');"
                     onclick="goToSlide(<?php echo e($index); ?>)"></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php endif; ?>
    </section>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div class="fade-in group" style="animation-delay: 0.1s;">
                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                    ...
                    <div class="text-5xl font-bold text-white mb-2 stat-number">
                        <?php echo e(number_format($statistik->jumlah_penduduk ?? 6075)); ?>
            ...
            <div class="fade-in group" style="animation-delay: 0.2s;">
                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                    ...
                    <div class="text-5xl font-bold text-white mb-2 stat-number">
                        <?php echo e(number_format($statistik->kepala_keluarga ?? 345)); ?>
            ...
            <div class="fade-in group" style="animation-delay: 0.3s;">
                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                    ...
                    <div class="text-5xl font-bold text-white mb-2 stat-number">
                        <?php echo e($statistik->jumlah_dusun ?? 6); ?>
            ...
            <div class="fade-in group" style="animation-delay: 0.4s;">
                <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                    ...
                    <div class="text-5xl font-bold text-white mb-2 stat-number">
                        <?php echo e(($statistik->jumlah_rt ?? 25)); ?>/<?php echo e(($statistik->jumlah_rw ?? 11)); ?>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="fade-in bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all" style="animation-delay: 0.5s;">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        <div class="text-3xl font-bold text-white"><?php echo e($statistik->luas_wilayah ?? '319.64'); ?> Ha</div>
            ...
            <div class="fade-in bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all" style="animation-delay: 0.6s;">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        <div class="text-3xl font-bold text-white"><?php echo e($statistik->ketinggian ?? 63); ?> mdpl</div>
            ...
            <div class="fade-in bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6" style="animation-delay: 0.7s;">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-blue-200 text-sm">Diperbarui: <?php echo e(now()->format('d M Y')); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<section id="profil" class="py-24 bg-gradient-to-b from-white to-gray-50">
    ...
    <section id="struktur-organisasi" class="py-24 relative overflow-hidden">
                ...
                <div class="absolute inset-0 z-0">
                    <div class="absolute inset-0 bg-cover bg-center bg-fixed" style="background-image: url('<?php echo e($visiMisiBgPath); ?>');"></div>
                        ...
                        <div class="relative w-full max-w-6xl">
                            ...
                            <div class="relative bg-white/10 backdrop-blur-md border-2 border-white/40 rounded-full p-12 md:p-16 shadow-2xl">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('images/struktur-organisasi.jpg')); ?>" 
                                            alt="Struktur Organisasi Desa Ngadirejo" 
                                            class="w-full h-auto rounded-2xl shadow-2xl">
                                    <?php endif; ?>
                                </div>
                        ...
                        <?php $__currentLoopData = $misi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-gradient-to-br from-blue-50 to-white p-6 rounded-2xl border-2 border-blue-100 hover:border-blue-400 hover:shadow-xl transition-all duration-300">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-grow">
                                        <p class="text-lg text-gray-800 leading-relaxed font-medium"><?php echo e($item); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($beritaTerbaru->count() > 0): ?>
                <div class="grid md:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $beritaTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $berita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="news-card bg-white rounded-2xl shadow-lg overflow-hidden group cursor-pointer" onclick="window.location='<?php echo e(route('berita.show', $berita->slug)); ?>'">
                            <div class="relative overflow-hidden h-56">
                                <?php if($berita->gambar_header): ?>
                                    <img src="<?php echo e(asset('storage/' . $berita->gambar_header)); ?>" 
                            ...
                            <div class="p-6">
                                <div class="flex items-center text-sm text-gray-500 mb-3">
                                    ...
                                    <span><?php echo e($berita->user->name); ?></span>
                                ...
                                <p class="text-gray-600 mb-4 line-clamp-3 text-sm leading-relaxed">
                                    <?php echo e(Str::limit(strip_tags($berita->konten), 120)); ?>
                ...
                <div class="text-center mt-12">
                    <a href="<?php echo e(route('publikasi.index')); ?>" class="read-more-btn inline-flex items-center px-6 py-3 rounded-full text-white font-semibold">
...
</html><?php /**PATH X:\hasil coding\Web-Project-KKN-Ngadirejo\resources\views/welcome.blade.php ENDPATH**/ ?>