...
<?php $component->withAttributes([]); ?>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                        ...
                        <?php if($siteLogo && $siteLogo->value): ?>
                            <div class="mb-6">
                                ...
                                <form action="<?php echo e(route('admin.settings.site-logo.delete')); ?>" 
                                      method="POST" 
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border-2 border-dashed border-gray-300 dark:border-gray-600">
                            ...
                            <form action="<?php echo e(route('admin.settings.site-logo')); ?>" 
                                  method="POST" 
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                        ...
                        <?php if(isset($heroBackgrounds) && $heroBackgrounds->count() > 0): ?>
                            <div class="mb-6">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Background Aktif (<?php echo e($heroBackgrounds->count()); ?>):</label>
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <?php $__currentLoopData = $heroBackgrounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php 
                                        ...
                                        <div class="relative group">
                                            <img src="<?php echo e(asset('storage/' . $bg->value)); ?>" 
                                                 alt="Hero Background <?php echo e($bgId); ?>" 
                                                 class="w-full h-40 object-cover rounded-lg shadow-lg border-2 border-gray-300 dark:border-gray-600">
                                            
                                            <form action="<?php echo e(route('admin.settings.hero-background.delete', $bgId)); ?>" 
                                                  method="POST" 
                                ...
                                <form action="<?php echo e(route('admin.settings.hero-background.delete-all')); ?>" 
                                      method="POST" 
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border-2 border-dashed border-gray-300 dark:border-gray-600">
                            ...
                            <form action="<?php echo e(route('admin.settings.hero-background')); ?>" 
                                  method="POST" 
                                  enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                        ...
                        <div class="mb-6 p-4 bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-300 dark:border-gray-600">
                            ...
                            <div class="text-center py-8">
                                <h1 class="text-5xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($currentTitle); ?></h1>
                                <p class="text-xl text-gray-600 dark:text-gray-400"><?php echo e($currentTagline); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border-2 border-dashed border-gray-300 dark:border-gray-600">
                            ...
                            <form action="<?php echo e(route('admin.settings.hero-text')); ?>" 
                                  method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="hero_tagline" 
                                           value="<?php echo e($currentTagline); ?>"
                                           class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                        ...
                        <?php if($strukturOrganisasiImage && $strukturOrganisasiImage->value): ?>
                            <div class="mb-6">
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Gambar Struktur Organisasi Saat Ini:</label>
                                <div class="relative flex justify-center">
                                    <img src="<?php echo e(asset('storage/' . $strukturOrganisasiImage->value)); ?>" 
                                ...
                                <form action="<?php echo e(route('admin.settings.struktur-organisasi.delete')); ?>" 
                                    method="POST" 
                                    class="mt-4 text-center"
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border-2 border-dashed border-gray-300 dark:border-gray-600">
                            ...
                            <form action="<?php echo e(route('admin.settings.struktur-organisasi')); ?>" 
                                method="POST" 
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                        ...
                        <?php if($bpdStructureImage && $bpdStructureImage->value): ?>
                            <div class="mb-6">
                                ...
                                <form action="<?php echo e(route('admin.settings.bpd-structure.delete')); ?>" 
                                    method="POST" 
                                    class="mt-4 text-center"
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border-2 border-dashed border-gray-300 dark:border-gray-600">
                            ...
                            <form action="<?php echo e(route('admin.settings.bpd-structure')); ?>" 
                                method="POST" 
                                enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border-2 border-dashed border-gray-300 dark:border-gray-600 mb-6">
                            ...
                            <?php if($profilDesaImage && $profilDesaImage->value): ?>
                                <div class="mb-6">
                                    ...
                                    <form action="<?php echo e(route('admin.settings.profil-desa-image.delete')); ?>" 
                                        method="POST" 
                                        class="mt-4 text-center"
                            ...
                            <form action="<?php echo e(route('admin.settings.profil-desa-image')); ?>" 
                                method="POST" 
                                enctype="multipart/form-data"
                                class="mb-6">
                                <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border-2 border-dashed border-gray-300 dark:border-gray-600">
                            ...
                            <form action="<?php echo e(route('admin.settings.profil-desa-text')); ?>" 
                                  method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="profil_desa_description" 
                                              ...
                                              maxlength="1000"
                                              required><?php echo e($profilDesaDescription ? $profilDesaDescription->value : 'Desa Ngadirejo adalah desa yang terletak di Kecamatan Wonoasri, Kabupaten Madiun, Provinsi Jawa Timur. Desa ini memiliki potensi yang besar dalam sektor pertanian, terutama sebagai penghasil padi dan hasil pertanian lainnya.'); ?></textarea>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 mb-6">
                        ...
                        <div class="mb-6 p-4 bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-300 dark:border-gray-600">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-700 dark:text-gray-300"><?php echo e($currentVisi); ?></p>
                                </div>
                                <div>
                                    <h4 class="text-lg font-bold text-indigo-600 mb-2">Misi</h4>
                                    <ul class="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300">
                                        <?php $__currentLoopData = $currentMisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border-2 border-dashed border-gray-300 dark:border-gray-600">
                            ...
                            <form action="<?php echo e(route('admin.settings.visi-misi')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea name="visi" 
                                            ...
                                            maxlength="1000"
                                            required><?php echo e($currentVisi); ?></textarea>
                                    <p class="text-gray-500 text-sm mt-1">Maksimal 1000 karakter</p>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div id="misiContainer" class="space-y-3">
                                        <?php $__currentLoopData = $currentMisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="misi-item flex gap-2">
                                                <textarea name="misi[]" 
                                                        ...
                                                        placeholder="Masukkan misi ke-<?php echo e($index + 1); ?>..."
                                                        maxlength="500"
                                                        required><?php echo e($item); ?></textarea>
                                                <button type="button" 
    ...
    <script>
        let misiCounter = <?php echo e(count($currentMisi)); ?>;
...
<?php endif; ?><?php /**PATH X:\hasil coding\Web-Project-KKN-Ngadirejo\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>