...
<head>
    ...
    <title><?php echo e($berita->judul); ?> - Desa Ngadirejo</title>
                ...
                <article class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                        ...
                        <div class="flex flex-wrap items-center gap-6 text-gray-600 mb-8 pb-8 border-b border-gray-200">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-gray-900"><?php echo e($berita->user->name); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-gray-900"><?php echo e($berita->created_at->format('d F Y')); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="ml-auto flex items-center space-x-3">
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(request()->url())); ?>" target="_blank" class="share-btn w-10 h-10 rounded-full bg-blue-600 hover:bg-blue-700 flex items-center justify-center shadow-md">
                                ...
                                <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(request()->url())); ?>&text=<?php echo e(urlencode($berita->judul)); ?>" target="_blank" class="share-btn w-10 h-10 rounded-full bg-sky-500 hover:bg-sky-600 flex items-center justify-center shadow-md">
                                ...
                                <a href="https://wa.me/?text=<?php echo e(urlencode($berita->judul . ' ' . request()->url())); ?>" target="_blank" class="share-btn w-10 h-10 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center shadow-md">
                    ...
                    <div class="px-8 md:px-12 pb-12">
                        <div class="article-content max-w-none">
                            <?php $__currentLoopData = $berita->blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                
                                <?php if($block->tipe == 'teks'): ?>
                                    <div class="mb-6">
                                        <?php echo nl2br(e($block->konten)); ?>

                                    </div>
                                
                                <?php elseif($block->tipe == 'gambar'): ?>
                                    <figure class="my-10">
                                        <img src="<?php echo e(asset('storage/' . $block->konten)); ?>" 
                                             alt="Gambar konten berita"
                                             class="w-full h-auto rounded-2xl shadow-xl">
                                    </figure>
                                
                                <?php elseif($block->tipe == 'pdf'): ?>
                                    <div class="my-10 bg-gray-50 p-8 rounded-2xl border-2 border-gray-200">
                                        ...
                                        <embed src="<?php echo e(asset('storage/' . $block->konten)); ?>" 
                                               type="application/pdf" 
                                               width="100%" 
                                               height="600px" 
                                               class="rounded-xl shadow-lg mb-4">
                                        <a href="<?php echo e(asset('storage/' . $block->konten)); ?>" 
                                           target="_blank" 
...
</html><?php /**PATH X:\hasil coding\Web-Project-KKN-Ngadirejo\resources\views/berita-show.blade.php ENDPATH**/ ?>