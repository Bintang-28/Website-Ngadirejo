...
<body>
    ...
    <section class="pt-24 pb-20 relative overflow-hidden min-h-screen flex items-center">
        ...
        <div class="absolute inset-0 z-0">
            <div class="absolute inset-0 bg-cover bg-center bg-fixed" style="background-image: url('<?php echo e($heroBg); ?>');"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
            <div class="text-center py-20">
                ...
                <div class="mt-12 flex justify-center">
                    <form class="w-full max-w-2xl" method="GET" action="<?php echo e(route('publikasi.index')); ?>">
                        <div class="relative">
            ...
            <?php if($berita->count() > 0): ?>
                <div class="grid md:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $berita; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="news-card bg-white rounded-2xl shadow-lg overflow-hidden group cursor-pointer" onclick="window.location='<?php echo e(route('berita.show', $item->slug)); ?>'">
                            <div class="relative overflow-hidden h-56">
                                <?php if($item->gambar_header): ?>
                                    <img src="<?php echo e(asset('storage/' . $item->gambar_header)); ?>" 
...
</html><?php /**PATH X:\hasil coding\Web-Project-KKN-Ngadirejo\resources\views/publikasi/index.blade.php ENDPATH**/ ?>