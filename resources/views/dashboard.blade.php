                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-2">
                                <h4 class="text-4xl font-bold text-gray-900 dark:text-white">
                                    {{ number_format($statistik->jumlah_penduduk ?? 0) }}
                                </h4>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div class="p-6">
                            ...
                            <div class="mt-2">
                                <h4 class="text-4xl font-bold text-gray-900 dark:text-white">
                                    {{ number_format($statistik->kepala_keluarga ?? 0) }}
                                </h4>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div class="p-6">
                            ...
                            <div class="mt-2">
                                <h4 class="text-4xl font-bold text-gray-900 dark:text-white">
                                    {{ $statistik->jumlah_rt ?? 0 }}/{{ $statistik->jumlah_rw ?? 0 }}
                                </h4>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $statistik->luas_wilayah ?? 0 }} Ha</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $statistik->ketinggian ?? 0 }} mdpl</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900 dark:text-white">{{ now()->format('d M Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
