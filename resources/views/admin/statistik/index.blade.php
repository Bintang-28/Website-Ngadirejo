                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ old('jumlah_penduduk', $statistik->jumlah_penduduk ?? 6075) }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ old('kepala_keluarga', $statistik->kepala_keluarga ?? 345) }}"
                                               class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                               required>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" 
                                               name="jumlah_dusun" 
                                               value="{{ old('jumlah_dusun', $statistik->jumlah_dusun ?? 6) }}"
                                               class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                               required>
                                        @error('jumlah_dusun')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="number" 
                                                   name="jumlah_rt" 
                                                   value="{{ old('jumlah_rt', $statistik->jumlah_rt ?? 25) }}"
                                                   class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                   required>
                                            @error('jumlah_rt')
                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" 
                                                   name="jumlah_rw" 
                                                   value="{{ old('jumlah_rw', $statistik->jumlah_rw ?? 11) }}"
                                                   class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                   required>
                                            @error('jumlah_rw')
                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    ...
                                    <div class="grid grid-cols-2 gap-4 md:col-span-2">
                                        <div>
                                            ...
                                            <input type="number" 
                                                   step="0.01" 
                                                   name="luas_wilayah" 
                                                   value="{{ old('luas_wilayah', $statistik->luas_wilayah ?? 319.64) }}"
                                                   class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                   required>
                                            @error('luas_wilayah')
                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" 
                                                   name="ketinggian" 
                                                   value="{{ old('ketinggian', $statistik->ketinggian ?? 63) }}"
                                                   class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                                                   required>
                                            @error('ketinggian')
                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    ...
                                    <div class="grid grid-cols-2 gap-4 md:col-span-2">
                                        <div>
                                            ...
                                            <input type="number" 
                                                   ...
                                                   value="{{ old('jumlah_laki_laki', $statistik->jumlah_laki_laki ?? null) }}"
                                                   class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" 
                                                   ...
                                                   value="{{ old('jumlah_perempuan', $statistik->jumlah_perempuan ?? null) }}"
                                                   class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4 md:col-span-2">
                                        <div>
                                            ...
                                            <input type="number" 
                                                   ...
                                                   value="{{ old('lahan_pertanian', $statistik->lahan_pertanian ?? null) }}"
                                                   class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" 
                                                   ...
                                                   value="{{ old('lahan_non_pertanian', $statistik->lahan_non_pertanian ?? null) }}"
                                                   class="block w-full px-4 py-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-6 rounded-lg text-center border border-blue-200 dark:border-blue-700">
                                        <div class="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2" id="preview-penduduk">
                                            {{ number_format(old('jumlah_penduduk', $statistik->jumlah_penduduk ?? 6075)) }}
                                        </div>
                                    ...
                                    <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-6 rounded-lg text-center border border-green-200 dark:border-green-700">
                                        <div class="text-3xl font-bold text-green-600 dark:text-green-400 mb-2" id="preview-kk">
                                            {{ number_format(old('kepala_keluarga', $statistik->kepala_keluarga ?? 345)) }}
                                        </div>
                                    ...
                                    <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-6 rounded-lg text-center border border-purple-200 dark:border-purple-700">
                                        <div class="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2" id="preview-dusun">
                                            {{ number_format(old('jumlah_dusun', $statistik->jumlah_dusun ?? 6)) }}
                                        </div>
                                    ...
                                    <div class="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 p-6 rounded-lg text-center border border-orange-200 dark:border-orange-700">
                                        <div class="text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2" id="preview-wilayah">
                                            {{ number_format(old('luas_wilayah', $statistik->luas_wilayah ?? 319.64), 2) }}
                                        </div>
