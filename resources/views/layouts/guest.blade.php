            ...
            <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12">
                <div class="max-w-md text-white z-10">
                    <div class="mb-8 float-animation">
                        <img src="{{ $logoPath }}" alt="Logo Desa" class="h-32 w-32 mx-auto drop-shadow-2xl rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
                    </div>
                ...
                <div class="w-full max-w-md">
                    ...
                    <div class="lg:hidden flex justify-center mb-8">
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4">
                            <img src="{{ $logoPath }}" alt="Logo Desa" class="h-20 w-20 drop-shadow-lg">
                        </div>
                    </div>
                    ...
                    <div class="mt-6 text-center text-white text-sm">
                        <p class="mb-2">© {{ date('Y') }} Desa Ngadirejo. All rights reserved.</p>
